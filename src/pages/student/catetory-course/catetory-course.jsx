...
export default function CatetoryCourse() {
  ...
  return (
    <section>
      ...
      <div className="p-12">
        <div className="">
          <btn className="inline-block rounded-3xl py-3 px-2.5 cursor-default border-2 border-[#e4e4e4] outline-none transition-all duration-500 ease-linear font-medium hover:border-2 hover:border-[#113d3c]   hover:scale-98">
